...
% if n > 1000, error('Beier curve for more than 1000 points is not allowed'); end
...
hold on, hbc = plot(bezcurve(:, 1), bezcurve(:, 2), 'LineWidth', 2, 'Color', 'r');  % plots the Bezier curve
